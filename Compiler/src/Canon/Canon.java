...
public class Canon {
    static boolean isNop(Tree.Stm a) {
        return a instanceof Tree.EXP_STM
                && ((Tree.EXP_STM)a).exp instanceof Tree.CONST;
    }
    ...
    static Tree.Stm do_stm(Tree.Stm s) {
        ...
        else if (s instanceof Tree.EXP_STM)
            return do_stm((Tree.EXP_STM)s);
        else
            return reorder_stm(s);
    }
    ...
    static final Tree.Stm nopNull = new Tree.EXP_STM(new Tree.CONST(0));
