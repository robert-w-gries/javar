...
class BS{
	...
	aux01 = this.Init(sz);
	aux02 = this.Print();
	if (this.Search(8)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(19)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(20)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(21)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(37)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(38)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(39)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
	if (this.Search(50)) Xinu.printint(1) ;
	else Xinu.printint(0) ;
