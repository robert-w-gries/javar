...
class LL{
	...
	Xinu.printint(head.Search(el02));
	Xinu.printint(head.Search(el03));
	Xinu.printint(10000000);
	...
	head = head.Insert(el01);
	aux01 = head.Print();
	Xinu.printint(2220000);

	head = head.Delete(el02);
	aux01 = head.Print();
	Xinu.printint(33300000);


	head = head.Delete(el01);
	aux01 = head.Print();
	Xinu.printint(44440000);
