/* JavarParser.java */
/* Generated By:JavaCC: Do not edit this line. JavarParser.java */
package frontend.parse;

import java.util.LinkedList;
import frontend.parse.ast.*;

public class JavarParser implements JavarParserConstants {
...
// Goal ::= MainClassDeclaration ( ClassDeclaration | ThreadDeclaration )* <EOF>
  static final public Program Goal() throws ParseException {// Variable declarations go here
    ...
    jj_consume_token(0);
{if ("" != null) return new Program(classList);}
    throw new Error("Missing return statement in function");
}

// ClassName ::= "class" <ID>
  static final public String ClassName() throws ParseException {Token className;
    jj_consume_token(32);
    className = jj_consume_token(ID);
{if ("" != null) return className.image;}
    throw new Error("Missing return statement in function");
}

// MainClassDeclaration ::=	ClassName "{" "public" "static" "void" "main" "(" "String" "[" "]" <ID> ")" "{" ( VarDeclaration )* ( Statement )* "}" "}"
  static final public void MainClassDeclaration(LinkedList<ClassDecl> classList) throws ParseException {String name;
        Token argsId;
...
// ClassDeclaration	::=	ClassName ( "extends" <ID> )? "{" ( FieldDeclaration | MethodDeclaration | VoidDeclaration )* "}"
  static final public void ClassDeclaration(LinkedList<ClassDecl> classList) throws ParseException {String name;
        Token parent = null;
...
// ThreadDeclaration ::= ClassName "extends" "Thread" "{" ( FieldDeclaration | MethodDeclaration | VoidDeclaration )* "}"
  static final public void ThreadDeclaration(LinkedList<ClassDecl> classList) throws ParseException {String name;
        LinkedList<VarDecl> fields = new LinkedList<VarDecl>();
        LinkedList<MethodDecl> methods = new LinkedList<MethodDecl>();
    name = ClassName();
    jj_consume_token(33);
...
// VarDeclaration ::= Type <ID> ( "=" Expression )? ";"
  static final public void VarDeclaration(LinkedList<VarDecl> vars) throws ParseException {Type type;
        Token id;
        Expr init = null;
    type = Type();
...
// MethodDeclaration ::= "public" ( "synchronized" )? Type <ID> "(" ( Type <ID> ( "," Type <ID> )* )? ")" "{" ( VarDeclaration )* ( Statement )* "return" Expression ";" "}"
  static final public void MethodDeclaration(LinkedList<MethodDecl> methods) throws ParseException {Type returnType;
        Token id;
        boolean sync = false;
        Type paramType;
        Token paramId;
...
// VoidDeclaration ::= "public" "void" <ID> "(" ")" "{" ( VarDeclaration )* ( Statement )* "}"
  static final public void VoidDeclaration(LinkedList<MethodDecl> methods) throws ParseException {Token id;
        LinkedList<VarDecl> locals = new LinkedList<VarDecl>();
        LinkedList<Stmt> statements = new LinkedList<Stmt>();
    jj_consume_token(27);
    jj_consume_token(29);
...
// FieldDeclaration ::= Type <ID> ";"
  static final public void FieldDeclaration(LinkedList<VarDecl> fields) throws ParseException {Type type;
        Token id;
    type = Type();
    id = jj_consume_token(ID);
    jj_consume_token(26);
...
//      |   "boolean" ( "[" "]" )*
//      |   "int" ( "[" "]" )*
  static final public Type Type() throws ParseException {Token id = null;
        int dimensions = 0;
...
//           |   Expression "=" Expression ";"
  static final public void Statement(LinkedList<Stmt> statements) throws ParseException {LinkedList<Stmt> innerStatements = new LinkedList<Stmt>();
...
// Expression ::= Expression1 ( "||" Expression1 )*
  static final public Expr Expression() throws ParseException {Expr left, right = null;
...
// Expression1 ::= Expression2 ( "&&" Expression2 )*
  static final public Expr Expression1() throws ParseException {Expr left, right = null;
        LinkedList<Expr> exprs = new LinkedList<Expr>();
    left = Expression2();
    label_14:
    while (true) {
...
//			   |   Expression3 ( "!=" Expression3 )*
  static final public Expr Expression2() throws ParseException {Expr left, right = null;
        LinkedList<Expr> exprs = new LinkedList<Expr>();
...
//			   |   Expression4 ( ">" Expression4 )*
  static final public Expr Expression3() throws ParseException {Expr left, right = null;
    LinkedList<Expr> exprs = new LinkedList<Expr>();
    LinkedList<String> types = new LinkedList<String>();
    left = Expression4();
    label_16:
...
//			   |   Expression5 ( "-" Expression5 )*
  static final public Expr Expression4() throws ParseException {Expr left, right = null;
    LinkedList<Expr> exprs = new LinkedList<Expr>();
    LinkedList<String> types = new LinkedList<String>();
    left = Expression5();
    label_17:
...
//			   |   Expression6 ( "/" Expression6 )*
  static final public Expr Expression5() throws ParseException {Expr left, right = null;
    LinkedList<Expr> exprs = new LinkedList<Expr>();
    LinkedList<String> types = new LinkedList<String>();
    left = Expression6();
    label_18:
...
//             |	( "!" )+ Expression7
//             |   Expression7
  static final public Expr Expression6() throws ParseException {Expr expr;
    LinkedList<String> types = new LinkedList<String>();
    label_19:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
// Expression7 ::=	( "(" Expression ")" | Expression8 ) ( "." <ID> ( MethodCall )? | "[" Expression "]" )*
  static final public Expr Expression7() throws ParseException {Expr left, right = null;
        LinkedList<Expr> exprs = new LinkedList<Expr>();
        Token id = null;
    ...
    while (true) {
      ...
      if (jj_2_11(2)) {
        jj_consume_token(12);
        id = jj_consume_token(ID);
ids.add(id); paramses.add(new LinkedList<Expr>()); exprs.add(null);
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case 6:{
...
for (int i = 0; i < exprs.size(); i++) {
  ...
  static final public Expr ArrayExpression() throws ParseException {Expr left, right = null;
        LinkedList<Expr> exprs = new LinkedList<Expr>();
    left = Expression8();
    label_21:
    while (true) {
...
// MethodCall ::= "(" ( Expression ( "," Expression )* )? ")"
  static final public void MethodCall(LinkedList<Expr> exprs) throws ParseException {Expr expr;
    jj_consume_token(6);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 6:
    case 13:
...
//             |	"this"
//             |	"null"
  static final public Expr Expression8() throws ParseException {Type type = null;
        Expr expr = null;
        Token xinuId = null;
        LinkedList<Expr> exprs = new LinkedList<Expr>();
        Token terminal = null;
...
if (exprType.equals("newobj")) {if ("" != null) return new NewObjectExpr(type);}
                else if (exprType.equals("newarr")) {if ("" != null) return new NewArrayExpr(type, exprs);}
                else if (exprType.equals("xinu")) {if ("" != null) return new XinuCallExpr(xinuId.image, exprs);}
                else if (exprType.equals("id")) {if ("" != null) return new IdentifierExpr(terminal.image);}
                else if (exprType.equals("int")) {if ("" != null) return new IntegerLiteral(new Integer(terminal.toString()));}
                else if (exprType.equals("string")) {if ("" != null) return new StringLiteral(terminal.toString());}
                else if (exprType.equals("true")) {if ("" != null) return new TrueExpr();}
                else if (exprType.equals("false")) {if ("" != null) return new FalseExpr();}
                else if (exprType.equals("this")) {if ("" != null) return new ThisExpr();}
                else /* null */ {if ("" != null) return new NullExpr();}
    throw new Error("Missing return statement in function");
}

  static final public Expr AssignableExpression() throws ParseException {Expr expr;
        Token id;
    if (jj_2_16(2)) {
...
// NewDecl ::= "new" Type
  static final public Type NewDecl() throws ParseException {Token id;
        Type type;
    jj_consume_token(45);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
...
{if ("" != null) return type;}
  ...
  static private boolean jj_3_6()
 {
  ...
  static public JavarParserTokenManager token_source;
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x0,0x400,0x0,0x8000000,0x0,0x8000000,0x8000000,0x0,0x8000000,0x100000,0x0,0x2000000,0x0,0x400,0x400,0x0,0x400,0x400,0x0,0x1000000,0x800000,0x600000,0x600000,0xc0000,0xc0000,0x22000,0x22000,0x18000,0x18000,0x6000,0x4000,0x40,0x1100,0x40,0x100,0x2000000,0x6040,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x1,0x1,0xc803fa0,0x2,0x800c000,0x800c000,0x0,0x800c000,0x800c000,0x0,0x0,0x8,0x0,0x800c000,0xc803fa0,0xc803fa0,0x800c000,0xc803fa0,0xa0,0xc803f00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc803f00,0x0,0x0,0x0,0x0,0xc803f00,0xc801f00,0x8000000,0x800c000,};
	}
  ...
  public JavarParser(java.io.InputStream stream) {
	  this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JavarParser(java.io.InputStream stream, String encoding) {
	 ...
	 token_source = new JavarParserTokenManager(jj_input_stream);
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
  ...
  /** Constructor. */
  public JavarParser(java.io.Reader stream) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
 ...
 token_source = new JavarParserTokenManager(jj_input_stream);
  ...
  public JavarParser(JavarParserTokenManager tm) {
	 if (jj_initialized_once) {
	   System.out.println("ERROR: Second call to constructor of static parser. ");
	   System.out.println("	   You must either use ReInit() or set the JavaCC option STATIC to false");
	   System.out.println("	   during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(JavarParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
