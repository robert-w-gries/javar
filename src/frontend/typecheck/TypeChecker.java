...
public class TypeChecker implements TypeVisitor {
    ...
    public List<Type> visit(AbstractList list) {
        ...
        for (Object obj : list) {
            types.add(((Absyn)obj).accept(this));
        }
        return types;
    }
    ...
    @Override
    public CLASS visit(ClassDecl ast) {
        CLASS cls = null;
        switch (state) {
            case PUT_CLASSES:
    ...
    @Override
    public CLASS visit(ThreadDecl ast) {
    ...
    @Override
    public ARRAY visit(ArrayType ast) {
        return new ARRAY(ast.baseType.accept(this));
    }

    @Override
    public INT visit(IntegerType ast) {
        return new INT();
    }
    ...
    @Override
    public BOOLEAN visit(BooleanType ast) {
        return new BOOLEAN();
    }
