...
public class MipsFrame extends Frame {
    ...
    public void procEntryExit1(List<Stm> stms) {
        ...
        for (int i = formals.size()-1; i >= 0; i--) {
            stms.add(0, new frontend.translate.irtree.MOVE(formals.get(i).exp(_sp), actuals.get(i).exp(_sp)));
        }

        // CALLEE SAVES

        // frame pointer
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(fp), new TEMP(new Temp(30))));
        // s registers
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s7), new TEMP(new Temp(23))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s6), new TEMP(new Temp(22))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s5), new TEMP(new Temp(21))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s4), new TEMP(new Temp(20))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s3), new TEMP(new Temp(19))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s2), new TEMP(new Temp(18))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s1), new TEMP(new Temp(17))));
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(s0), new TEMP(new Temp(16))));
        // return address
        stms.add(0, new frontend.translate.irtree.MOVE(new TEMP(ra), new TEMP(new Temp(31))));
        ...
        // frame pointer
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(30)), new TEMP(fp)));
        // s registers
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(23)), new TEMP(s7)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(22)), new TEMP(s6)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(21)), new TEMP(s5)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(20)), new TEMP(s4)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(19)), new TEMP(s3)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(18)), new TEMP(s2)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(17)), new TEMP(s1)));
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(16)), new TEMP(s0)));
        // return address
        stms.add(new frontend.translate.irtree.MOVE(new TEMP(new Temp(31)), new TEMP(ra)));
    ...
    public void procEntryExit2(List<Instr> instrs) {
        ...
        instrs.add(new OPER("// Return from " + name.toString(), null, returnUses, null));
        List<Temp> ra = new LinkedList<>();
        ra.add(new Temp(31));
        instrs.add(new OPER("jr `s0", null, ra, null));
    }
    ...
    public void procEntryExit3(List<Instr> instrs) {
        ...
        entryInstrs.add(new OPER(".text"));
        entryInstrs.add(new OPER(".align\t4"));
        entryInstrs.add(new OPER(".globl\t" + this.name.toString()));
        entryInstrs.add(new backend.assem.LABEL(this.name.toString(), this.name));
        entryInstrs.add(new DIRECTIVE(this.name.toString() + "_framesize=" + frameSize));
        if (frameSize > 0) {
            entryInstrs.add(new OPER("addiu `d0, `s0, -" + frameSizeString, sp, sp, null));
            instrs.add(instrs.size()-1, new OPER("addiu `d0, `s0, " + frameSizeString, sp, sp, null));
        }
    ...
    private void munchStm(Stm s) {
        ...
        else if (s instanceof frontend.translate.irtree.LABEL) {
            emit(new backend.assem.LABEL(((frontend.translate.irtree.LABEL)s).label.toString(), ((frontend.translate.irtree.LABEL)s).label));
        } else if (s instanceof frontend.translate.irtree.MOVE) {
            frontend.translate.irtree.MOVE m = (frontend.translate.irtree.MOVE)s;
        ...
        if (e instanceof TEMP) {
            ...
            for (int i = 0; i < c.args.size(); i++) {
                if (i < 4) {
                    ...
                    munchStm(new frontend.translate.irtree.MOVE(new TEMP(new Temp(4+i)), c.args.get(i)));
                } else {
                    munchStm(new frontend.translate.irtree.MOVE(new MEM(new BINOP(BINOP.Operation.PLUS, new CONST(i*wordSize()), new TEMP(framePointer))), c.args.get(i)));
                }
